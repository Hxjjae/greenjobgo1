...
public class CompanylistController {
    ...
    @PostMapping
    /** summary = "회사 추가",description = "area: 지역 명 ex) 대구,서울 <br>"+
            "companyName: 회사 명 <br>"+
            "leaderName: 대표 이름 <br>"+
            "homepage: 홈페이지링크 <br>"+
            "manager : 담당자 이름 <br>"+
    ...
    /** "엑셀로 추가",description = "엑셀파일을 넣어주세요 <br> 리턴값이 1이면 정상 추가 됨") **/
    ...
    @PatchMapping
    /** (summary = "회사정보 수정",description = "companyCode: DB 회사 pk값 <br>" +
            "area: 지역 <br>"+
            "companyName: 회사 명 <br>"+
            "leaderName: 대표 이름 <br>"+
            "homepage: 홈페이지링크 <br>"+
    ...
    /** (summary = "회사 삭제",description = "리턴값이 1이면 삭제완료"+
