...
public class AdminCompanyController {
    ...
    @PostMapping("/sign-up")
    /** 회원가입, description = "스웨거에서 기업아이디를 생성하기 위한 메소드입니다. <br>"+
            "id : 아이디 <br>" +
            "pw : 패스워드 <br>" +
    ...
    @GetMapping
    /** 기업 아이디 조회", description = "기업아이디를 조회하기 위한 메소드입니다. <br>"+
            "icompany : PK번호 <br>" +
            "id : 아이디 <br>" +
            "startedAt : 권한부여(시작일) <br>" +
            "endedAt : 권한부여(종료일) <br>"  ) **/
    ...
    @PatchMapping()
    /** "열람권한 수정", description ="아이디 열람권한 및 비밀번호 수정을 하기 위한 메소드 입니다.<br>"+
            "icompany : PK번호 <br>" +
            "pw : 패스워드 <br>" +
            "startedAt : 권한부여(시작일) <br>" +
            "endedAt : 권한부여(종료일) <br>" )  **/
    ...
    /**"기업 아이디 삭제", description = "기업아이디를 삭제하기 위한 메소드입니다. <br>"+
            "icompany : PK번호 <br>") **/
